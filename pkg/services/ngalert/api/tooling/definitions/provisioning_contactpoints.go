...
// swagger:route PUT /api/provisioning/v1/contact-points/{ID} provisioning RoutePutContactpoint
//
...
// swagger:route DELETE /api/provisioning/v1/contact-points/{ID} provisioning RouteDeleteContactpoints
//
